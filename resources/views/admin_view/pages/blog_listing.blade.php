    ...
    <div class="content">
        <div class="row">
            ...
            <th style="width: 22px; padding: 5px 10px;" class="sorting_disabled" rowspan="1" colspan="1" aria-label="">
                ...
                <th class="sorting" tabindex="0" aria-controls="table_id" rowspan="1" colspan="1" aria-label="Username: activate to sort column ascending" style="width: 140px;">title</th>
                <th width="10%" class="sorting" tabindex="0" aria-controls="table_id" rowspan="1" colspan="1" aria-label="Country: activate to sort column ascending" style="width: 66px;">description</th>

                <th width="10%" class="sorting" tabindex="0" aria-controls="table_id" rowspan="1" colspan="1" aria-label="Gender: activate to sort column ascending" style="width: 66px;">image</th>
               ...
               <!--  <th width="7%" class="sorting" tabindex="0" aria-controls="table_id" rowspan="1" colspan="1" aria-label="Order: activate to sort column ascending" style="width: 38px;">Order</th>
                ...
                <th width="12%" class="sorting" tabindex="0" aria-controls="table_id" rowspan="1" colspan="1" aria-label="Actions: activate to sort column ascending" style="width: 87px;">Actions</th></tr>
                                            </thead><tbody>
                                            @foreach($list as $row)
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td><?=$row['title']; ?></td>
                                                <td><?=$row['desc']; ?></td>
                                                <td><img style="width: 81px;height: 85px;" src="{{asset('images')}}/<?=$row['img']; ?>"</td>
                                               <!--  <td>32</td>
                                                <td>20-05-2014</td>
                                                <td>$112.40</td> -->
                                                <td><a href="blog_status/submit/<?=$row['id']; ?>"><span class="label label-sm label-danger">unproved</span></a>
                                                </td>
                                                <td>
                                                    <a href="blog_listing/edit/{{$row['id'] }}"  class="btn btn-default btn-xs"><i class="fa fa-edit"></i>&nbsp;
                                                        Edit
                                                    </a>
                                                      <a href="blog_listing/delete/{{$row['id'] }}"  class="btn btn-default btn-xs"><i class="fa fa-edit"></i>&nbsp;
                                                       Delete
                                                    </a>
